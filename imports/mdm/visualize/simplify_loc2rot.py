...
import os
import torch
from imports.mdm.visualize.joints2smpl.src import config
import smplx
import h5py
from imports.mdm.visualize.joints2smpl.src.smplify import SMPLify3D
from tqdm import tqdm
import imports.mdm.utils.rotation_conversions as geometry
import argparse
...
class joints2smpl:
    ...
    def joint2smpl(self, input_joints, init_params=None):
        ...
        return thetas.clone().detach(), {'pose': new_opt_pose.clone().detach(), 'betas': new_opt_betas.clone().detach(), 'cam': new_opt_cam_t.clone().detach()}
