...
import numpy as np
import torch
from imports.mdm.utils.parser_util import generate_args
from imports.mdm.utils.model_util import create_model_and_diffusion, load_model_wo_clip
from imports.mdm.utils import dist_util
from imports.mdm.model.cfg_sampler import ClassifierFreeSampleModel
from imports.mdm.data_loaders.get_data import get_dataset_loader
from imports.mdm.data_loaders.humanml.scripts.motion_process import recover_from_ric
from imports.mdm.utils.parser_util import add_base_options, add_data_options, add_model_options, add_diffusion_options, add_training_options, add_generate_options, add_sampling_options
import imports.mdm.data_loaders.humanml.utils.paramUtil as paramUtil
from imports.mdm.data_loaders.humanml.utils.plot_script import plot_3d_motion
import shutil
from imports.mdm.data_loaders.tensors import collate
import argparse
...
def main(args):
    ...
    lora_keys = [key for key in state_dict.keys() if "lora" in key]
    for lora_key in lora_keys:
        state_dict[lora_key] = state_dict[lora_key] * args.lora_weight
